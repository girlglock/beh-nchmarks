!(function (e, t) {
    ...
    (() => {
        ...
        var e = {
                d: (t, i) => {
                    for (var n in i)
                        e.o(i, n) && !e.o(t, n) && Object.defineProperty(t, n, { enumerable: !0, get: i[n] });
                },
        ...
        s.VantaBase = class {
            constructor(e = {}) {
                    ...
                    return (
                        ...
                        void (
                            ...
                            (this.el.style.background =
                                ...
                                "number" == typeof a ? "#" + ("00000" + a.toString(16)).slice(-6) : a)))
                        )
                    );
                }
                ...
                h("resize", this.resize),
                    ...
                    this.options.mouseControls &&
                        (h("scroll", this.windowMouseMoveWrapper), h("mousemove", this.windowMouseMoveWrapper)),
                    this.options.touchControls &&
                        (h("touchstart", this.windowTouchWrapper), h("touchmove", this.windowTouchWrapper)),
            ...
            windowMouseMoveWrapper(e) {
                ...
                i >= 0 &&
                    ...
                    i <= t.width &&
                    n <= t.height &&
                    ((this.mouseX = i), (this.mouseY = n), this.options.mouseEase || this.triggerMouseMove(i, n));
            }
        ...
        class c extends a {
            ...
            init() {
                (this.mode = "shader"),
                    (this.uniforms = {
                        ...
                        iMouse: { type: "v2", value: new h.Vector2(this.mouseX || 0, this.mouseY || 0) },
                    }),
                    super.init(),
            ...
            initBasicShader(e = this.fragmentShader, t = this.vertexShader) {
                ...
                const i = new h.ShaderMaterial({ uniforms: this.uniforms, vertexShader: t, fragmentShader: e }),
